<div>
    ...
    <x-section-title>
        <x-slot name="title">لیست گروه ها</x-slot>
        ...
        <div>
            <div class="flex">
                <div class="shadow rounded-lg relative">
                    <a href="{{ route('panel.group-create') }}"
        ...
        <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
            ...
            @foreach($groups as $group)
                <tr class="">
                    ...
                    <td class="p-2 border-dashed border-t border-gray-200">
                        <x-abutton class="p-2" color=blue href="{{ route('panel.group-edit', $group) }}">
                            <x-icons.edit class="w-4 h-4 text-white"/>
                        </x-abutton>
                    </td>

                    <td class="p-2 border-dashed border-t border-gray-200">
                        <x-button class="p-2" color=red type="button" wire:click="delete('{{$group->slug}}')">
                            <x-icons.delete class="w-4 h-4 text-white"/>
                        </x-button>
                    </td>
