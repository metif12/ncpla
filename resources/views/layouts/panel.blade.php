        ...
        <div class="flex h-screen w-screen overflow-y-hidden" x-data="setup()"
            ...
            >
                ...
                <div class="flex items-center justify-between flex-shrink-0 p-2"
                    ...
                    <span class="p-2 w-full text-center inline-block text-xl font-semibold leading-8 tracking-wider uppercase whitespace-nowrap">
                ...
                <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
                    <ul class="p-2 overflow-hidden">
                        <li>
                            <a
                                href="#"
                                class="flex items-center bg-gray-50 items-baseline p-2 space-x-2 rounded-md hover:bg-white"
                            ...
                            >
                                ...
                                <span class="pr-1" :class="{ 'lg:hidden': !isSidebarOpen }">Dashboard</span>
                            </a>
                        </li>
                        <!-- Sidebar Links... -->
                    </ul>
