            ...
            <div class="items-center hidden space-x-3 md:flex">
                ...
                <div class="relative ml-3" x-data="{ isOpen: false }">
                    ...
                    <div
                        ...
                        class="w-48 max-w-md absolute mt-3 left-0 bg-white border rounded-md shadow-xl min-w-max"
                    >
                ...
                <div class="relative" x-data="{ isOpen: false }">
                    ...
                    <div
                        @click.away="isOpen = false"
                        x-show.transition.opacity="isOpen"
                        class="w-40 max-w-sm absolute mt-3 left-0 bg-white border rounded-md shadow-xl min-w-max"
                    >
                        <div class="p-4 font-medium border-b">
